...
class LearningAgent(Agent):
	...
	def reset(self, destination=None, testing=False):
		...
		if testing:
			...
			# self.epsilon = math.exp(-1*self.t*self.alpha)
			self.epsilon = 1.5*math.cos(self.alpha*self.t)
		return None
	...
	def build_state(self):
		...
		state = str(tuple([waypoint, inputs['light'], inputs['oncoming'], inputs['left']]))
		return state
...
def run():
	...
	agent = env.create_agent(LearningAgent, learning=True, alpha=0.005, epsilon=1.0)
